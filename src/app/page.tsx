...
export default async function Index() {
  ...
  return (
    <div className="lg:flex lg:justify-between lg:gap-4">
      <header id="home-sidebar" className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-12 2xl:py-24">
        <div className="sm:pr-24 flex flex-col">
          ...
          <nav className="nav">
            <ul className="mt-3 w-max md:mt-16 mb-3 md:mb-16">
              <li>
        ...
        <div className="flex-1 flex flex-col justify-end w-full sm:pr-24">
          <Chatbot />
          <Socials />
        </div>
      ...
      <main className="pt-24 lg:w-1/2 2xl:py-24 lg:py-12">
